...
1. **Full test suite:** `uv run pytest` — capture pass/fail counts and any failure output. Baseline: **355 passed, 5 skipped, 0 failures** (measured 2026-09-14); new tasks add tests on top.
