...
- All tests: `uv run pytest` (measured 2026-09-13: **276 passed, 5 skipped — 0 failures**, including the `tests/conformance/` drift suite). Tests import the harness from `src/` and kits from `tools/*/src` via `[tool.pytest.ini_options] pythonpath`.
