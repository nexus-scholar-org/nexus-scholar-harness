...
- All tests: `uv run pytest` (measured 2026-09-13: **248 passed, 3 skipped — 0 failures**). Tests import the harness from `src/` and kits from `tools/*/src` via `[tool.pytest.ini_options] pythonpath`.
