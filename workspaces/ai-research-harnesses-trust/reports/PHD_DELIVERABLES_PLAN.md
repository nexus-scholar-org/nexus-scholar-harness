...
- **Remaining for submission (NOT manuscript defects)**: Vancouver restyle of 36 refs + strip Workspace tokens; PRISMA-ScR flow diagram; supplementary search-log (`literature/search_log_v1.json`) + preprint→published version table; OSF registration; re-sync stale counts in `pipeline_engineering_report.md` (13/23 wording) and methodology report (44 events).
