...
Precision (FP16/INT8/FP32) and input resolution (224–1000 px) jointly move throughput by an order of magnitude; only 2 studies report energy (J/inference or W). **Target-edge caveat:** SCI-000067 and SCI-000754 argue embedded feasibility (Jetson TX2/Nano; Jetson-class SKUs) while measuring on a desktop RTX 4090 and a cloud T4 — these are *not* on-device evidence and are reported separately (`synthesis/rq2_edge_tables.md`, Tables B–D). **Accelerator context:** desktop/cloud measurements (n = 13) reach 141–1611 FPS and are excluded from on-device guidance.
