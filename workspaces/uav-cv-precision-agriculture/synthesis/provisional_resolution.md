...
|---|---|---|---|---|
Counts: CONFIRMED=4 | CONFIRMED_PENDING_FULLTEXT=9 | EXCLUDE_TOPIC=8 | EXCLUDE_EXC06=5 | REVIEW_REQUIRED=13 (of 39 total)
...
| SCI-000095 | Unmanned Aerial Vehicle (UAV) in Precision Agriculture to Identify the | 2023 | REVIEW_REQUIRED | Metric keyword in abstract but no explicit numeric value — verify manually. |
...
| SCI-000140 | Mapping the future of farm management: A comprehensive analysis of app | 2024 | REVIEW_REQUIRED | No numeric segmentation metric observable in abstract; no fulltext. |
...
| SCI-000315 | Deteksi Objek Pohon Secara Real-Time dari Udara Menggunakan YOLOv8 pad | 2026 | REVIEW_REQUIRED | Metric keyword in abstract but no explicit numeric value — verify manually. |
...
| SCI-000398 | Unmanned Aerial Vehicle (UAV)-Based Hyperspectral Imaging System for P | 2020 | REVIEW_REQUIRED | No numeric segmentation metric observable in abstract; no fulltext. |
| SCI-000408 | Enhanced Agricultural Productivity: UAV-Based Technology for Precision | 2025 | REVIEW_REQUIRED | No numeric segmentation metric observable in abstract; no fulltext. |
| SCI-000411 | Precision Agriculture and Unmanned Aerial Vehicles (UAVs) | 2020 | REVIEW_REQUIRED | No numeric segmentation metric observable in abstract; no fulltext. |
...
| SCI-000426 | Real-time monitoring using unmanned aerial vehicle (UAV) | 2024 | REVIEW_REQUIRED | No numeric segmentation metric observable in abstract; no fulltext. |
| SCI-000433 | Application of unmanned aerial systems to address real-world issues in | 2023 | REVIEW_REQUIRED | No numeric segmentation metric observable in abstract; no fulltext. |
| SCI-000434 | 57. Optimizing peach management based on hyperspectral and unmanned ae | 2021 | REVIEW_REQUIRED | Metric keyword in abstract but no explicit numeric value — verify manually. |
| SCI-000439 | Applications of UAV-AD (Unmanned Aerial Vehicle-Agricultural Drones) i | 2024 | REVIEW_REQUIRED | No numeric segmentation metric observable in abstract; no fulltext. |
...
| SCI-000446 | Artificial Intelligence Implementation on Unmanned Aerial Vehicle for  | 2026 | REVIEW_REQUIRED | No numeric segmentation metric observable in abstract; no fulltext. |
...
| SCI-000666 | Overcome the Fear Of Missing Out: Active sensing UAV scanning for prec | 2023 | REVIEW_REQUIRED | Likely in scope with metrics not confidently abstracted; fulltext missing. |
...
| SCI-001127 | AI in weed management | 2025 | REVIEW_REQUIRED | Metric keyword in abstract but no explicit numeric value — verify manually. |
