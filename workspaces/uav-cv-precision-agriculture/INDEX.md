...
- **Last Updated**: `2026-09-07 01:32:54 UTC`
...
| :--- | :--- | :--- | :--- |
| `project.json` | Project manifest, metadata, and research questions | 2026-09-07 01:32 | Active |
| `INDEX.md` | Master project directory and status catalog | 2026-09-07 01:32 | Synced |
| `audit/journal.jsonl` | Append-only provenance event ledger | 2026-09-07 01:32 | Active |
